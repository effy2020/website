...
Route::get('/flotte/store', [App\Http\Controllers\Pos\FlotteController::class, 'store'])->name('flotte.store');
use App\Http\Controllers\Pos\FlotteController;

// Routes pour la gestion de la flotte
Route::prefix('flotte')->name('flotte.')->group(function () {
    Route::get('/flotte', [FlotteController::class, 'index'])->name('index');
    Route::get('/flottecreate', [FlotteController::class, 'create'])->name('add');
    Route::post('/flottestore', [FlotteController::class, 'store'])->name('store');
    Route::get('/flotteedit/{id}', [FlotteController::class, 'edit'])->name('edit');
    Route::put('/flotteupdate/{id}', [FlotteController::class, 'update'])->name('update');
    Route::delete('/flottedelete/{id}', [FlotteController::class, 'destroy'])->name('delete');
});
