            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Add Flotte</h4><br><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="md-3">
                                    <label for="example-text-input" class="form-label">Employer Name</label>
                            ...
                            <div class="col-md-4">
                                <div class="md-3">
                                    <label for="example-text-input" class="form-label">moving type</label>
                            ...
                            <div class="col-md-4">
                                <div class="md-3">
                                    <label for="example-text-input" class="form-label">With</label>
                            ...
                            <div class="col-md-6">
                                <div class="md-3">
                                    <label for="address_1" class="form-label">Departure Address</label>
                            ...
                            <div class="col-md-6">
                                <div class="md-3">
                                    <label for="address_2" class="form-label">Arrival Adress</label>
...
<script id="document-template" type="text/x-handlebars-template">
    <tr class="delete_add_more_item" id="delete_add_more_item">
        ...
        <td>
            <input type="text" class="form-control" name="description[]" value="@{{address_1}}, @{{address_2}}">
        </td>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(document).on("click", ".addeventmore", function(){
            ...
            // Compile and generate new row HTML
